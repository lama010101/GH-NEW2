      ...
      <div className={cn('relative flex flex-col gap-2', className)}>
            ...
            {timelineVisible ? (
              <>
                <div className="absolute left-0 right-0 top-4">
                  <div className="h-px w-full bg-gradient-to-r from-transparent via-foreground/40 to-transparent" />
                </div>
                          ...
                          return (
                            ...
                            >
                              ...
                              <div
                                ...
                                style={{ minWidth: '3ch', textAlign: 'center', opacity: isActive ? 1 : baseOpacity }}
                              >
                                {labelText}
                              </div>
                            </div>
        ...
        {timelineVisible ? (
          <div className="pointer-events-none absolute inset-x-0 bottom-0 flex justify-center px-0 z-10">
            <div className="flex w-full items-center gap-[0.01rem] rounded-full border border-foreground/10 bg-foreground/5 px-2 py-1.5 text-[0.62rem] uppercase tracking-[0.2em] text-foreground/70 shadow-sm">
