...
// ═════════════════════════════════════════════════════════════════════════════
// SECTION 1a: HARD ENFORCEMENT GUARD (MP-CORE-LOOP-005)
// ═════════════════════════════════════════════════════════════════════════════

/**
 * ANTI-FAKE: Assert DB connection was verified at module load.
 * This prevents any fake execution path where DB is bypassed.
 */
try {
  assertDbConnectionVerified();
  console.log("[HARNESS][ENFORCEMENT] ✅ DB connection verified at module load");
} catch (error) {
  console.error("[HARNESS][FATAL] DB connection not verified — possible fake path");
  throw error;
}
...
describe("MP-CORE-LOOP-004: Real DB Execution Proof Harness", () => {
  beforeAll(async () => {
    console.log("\n═══════════════════════════════════════════════════════════════");
