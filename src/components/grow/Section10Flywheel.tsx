  ...
  return (
    ...
    >
      <div className="relative z-10 flex max-w-4xl flex-col items-center gap-8 text-center">
        ...
        <StaggerGroup className="flex w-full max-w-2xl flex-col gap-4 rounded-[var(--gh-radius-md)] border border-[var(--gh-border-default)] bg-[var(--gh-bg-surface)] p-6 text-left">
          {section.visual.flow?.map((node, index) => (
            <StaggerItem key={node} className="flex items-center gap-4">
