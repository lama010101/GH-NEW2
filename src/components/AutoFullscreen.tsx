...
/**
 * Auto-enters fullscreen on the first user interaction. Browsers require a user
 * gesture to grant fullscreen, so this attaches one-time capture-phase listeners
 * for the first click/touchstart/keydown and requests fullscreen then.
 *
